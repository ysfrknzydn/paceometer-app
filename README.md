...
**A caveat on the wording itself:** "behind the fastest pace" (used both in the live readout and the end-of-trip caption) has been flagged as still confusing — "fastest pace" can read as literal top speed rather than "the point where extra speed stops mattering." The math above is settled; the exact phrase used to describe it on screen is not — see `TODO.md`.
